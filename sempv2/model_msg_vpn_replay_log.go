...
// MsgVpnReplayLog struct for MsgVpnReplayLog
...
func (o MsgVpnReplayLog) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnReplayLog struct {
	value *MsgVpnReplayLog
	isSet bool
}

func (v NullableMsgVpnReplayLog) Get() *MsgVpnReplayLog {
	return v.value
}

func (v *NullableMsgVpnReplayLog) Set(val *MsgVpnReplayLog) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnReplayLog) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnReplayLog) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnReplayLog(val *MsgVpnReplayLog) *NullableMsgVpnReplayLog {
	return &NullableMsgVpnReplayLog{value: val, isSet: true}
}

func (v NullableMsgVpnReplayLog) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnReplayLog) UnmarshalJSON(src []byte) error {
	v.isSet = true
