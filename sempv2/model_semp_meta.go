...
// SetError gets a reference to the given SempError and assigns it to the Error field.
...
// SetPaging gets a reference to the given SempPaging and assigns it to the Paging field.
...
func (o SempMeta) MarshalJSON() ([]byte, error) {
...
type NullableSempMeta struct {
	value *SempMeta
	isSet bool
}

func (v NullableSempMeta) Get() *SempMeta {
	return v.value
}

func (v *NullableSempMeta) Set(val *SempMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableSempMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableSempMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSempMeta(val *SempMeta) *NullableSempMeta {
	return &NullableSempMeta{value: val, isSet: true}
}

func (v NullableSempMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSempMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
