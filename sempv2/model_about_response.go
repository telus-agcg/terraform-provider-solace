...
// AboutResponse struct for AboutResponse
...
func (o AboutResponse) MarshalJSON() ([]byte, error) {
...
type NullableAboutResponse struct {
	value *AboutResponse
	isSet bool
}

func (v NullableAboutResponse) Get() *AboutResponse {
	return v.value
}

func (v *NullableAboutResponse) Set(val *AboutResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAboutResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAboutResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAboutResponse(val *AboutResponse) *NullableAboutResponse {
	return &NullableAboutResponse{value: val, isSet: true}
}

func (v NullableAboutResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAboutResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
