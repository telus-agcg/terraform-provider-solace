...
// MsgVpnJndiTopic struct for MsgVpnJndiTopic
...
// GetPhysicalName returns the PhysicalName field value if set, zero value otherwise.
func (o *MsgVpnJndiTopic) GetPhysicalName() string {
	if o == nil || o.PhysicalName == nil {
		var ret string
		return ret
	}
	return *o.PhysicalName
}

// GetPhysicalNameOk returns a tuple with the PhysicalName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnJndiTopic) GetPhysicalNameOk() (*string, bool) {
	if o == nil || o.PhysicalName == nil {
		return nil, false
	}
	return o.PhysicalName, true
}
...
// SetPhysicalName gets a reference to the given string and assigns it to the PhysicalName field.
...
func (o MsgVpnJndiTopic) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.MsgVpnName != nil {
		toSerialize["msgVpnName"] = o.MsgVpnName
	}
	if o.PhysicalName != nil {
		toSerialize["physicalName"] = o.PhysicalName
	}
	if o.TopicName != nil {
...
type NullableMsgVpnJndiTopic struct {
	value *MsgVpnJndiTopic
	isSet bool
}

func (v NullableMsgVpnJndiTopic) Get() *MsgVpnJndiTopic {
	return v.value
}

func (v *NullableMsgVpnJndiTopic) Set(val *MsgVpnJndiTopic) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnJndiTopic) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnJndiTopic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnJndiTopic(val *MsgVpnJndiTopic) *NullableMsgVpnJndiTopic {
	return &NullableMsgVpnJndiTopic{value: val, isSet: true}
}

func (v NullableMsgVpnJndiTopic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnJndiTopic) UnmarshalJSON(src []byte) error {
	v.isSet = true
