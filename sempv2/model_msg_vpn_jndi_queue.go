...
// MsgVpnJndiQueue struct for MsgVpnJndiQueue
...
func (o MsgVpnJndiQueue) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnJndiQueue struct {
	value *MsgVpnJndiQueue
	isSet bool
}

func (v NullableMsgVpnJndiQueue) Get() *MsgVpnJndiQueue {
	return v.value
}

func (v *NullableMsgVpnJndiQueue) Set(val *MsgVpnJndiQueue) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnJndiQueue) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnJndiQueue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnJndiQueue(val *MsgVpnJndiQueue) *NullableMsgVpnJndiQueue {
	return &NullableMsgVpnJndiQueue{value: val, isSet: true}
}

func (v NullableMsgVpnJndiQueue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnJndiQueue) UnmarshalJSON(src []byte) error {
	v.isSet = true
