...
// MsgVpnAclProfilePublishTopicException struct for MsgVpnAclProfilePublishTopicException
...
func NewMsgVpnAclProfilePublishTopicException() *MsgVpnAclProfilePublishTopicException {
	this := MsgVpnAclProfilePublishTopicException{}
	return &this
}
...
// GetPublishTopicException returns the PublishTopicException field value if set, zero value otherwise.
func (o *MsgVpnAclProfilePublishTopicException) GetPublishTopicException() string {
	if o == nil || o.PublishTopicException == nil {
		var ret string
		return ret
	}
	return *o.PublishTopicException
}

// GetPublishTopicExceptionOk returns a tuple with the PublishTopicException field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfilePublishTopicException) GetPublishTopicExceptionOk() (*string, bool) {
	if o == nil || o.PublishTopicException == nil {
		return nil, false
	}
	return o.PublishTopicException, true
}
...
// SetPublishTopicException gets a reference to the given string and assigns it to the PublishTopicException field.
func (o *MsgVpnAclProfilePublishTopicException) SetPublishTopicException(v string) {
	o.PublishTopicException = &v
}

// GetPublishTopicExceptionSyntax returns the PublishTopicExceptionSyntax field value if set, zero value otherwise.
func (o *MsgVpnAclProfilePublishTopicException) GetPublishTopicExceptionSyntax() string {
	if o == nil || o.PublishTopicExceptionSyntax == nil {
		var ret string
		return ret
	}
	return *o.PublishTopicExceptionSyntax
}

// GetPublishTopicExceptionSyntaxOk returns a tuple with the PublishTopicExceptionSyntax field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfilePublishTopicException) GetPublishTopicExceptionSyntaxOk() (*string, bool) {
	if o == nil || o.PublishTopicExceptionSyntax == nil {
		return nil, false
	}
	return o.PublishTopicExceptionSyntax, true
}
...
// SetPublishTopicExceptionSyntax gets a reference to the given string and assigns it to the PublishTopicExceptionSyntax field.
func (o *MsgVpnAclProfilePublishTopicException) SetPublishTopicExceptionSyntax(v string) {
	o.PublishTopicExceptionSyntax = &v
}

func (o MsgVpnAclProfilePublishTopicException) MarshalJSON() ([]byte, error) {
	...
	if o.PublishTopicException != nil {
		toSerialize["publishTopicException"] = o.PublishTopicException
	}
	if o.PublishTopicExceptionSyntax != nil {
		toSerialize["publishTopicExceptionSyntax"] = o.PublishTopicExceptionSyntax
	}
	return json.Marshal(toSerialize)
}

type NullableMsgVpnAclProfilePublishTopicException struct {
	value *MsgVpnAclProfilePublishTopicException
	isSet bool
}

func (v NullableMsgVpnAclProfilePublishTopicException) Get() *MsgVpnAclProfilePublishTopicException {
	return v.value
}

func (v *NullableMsgVpnAclProfilePublishTopicException) Set(val *MsgVpnAclProfilePublishTopicException) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnAclProfilePublishTopicException) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnAclProfilePublishTopicException) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnAclProfilePublishTopicException(val *MsgVpnAclProfilePublishTopicException) *NullableMsgVpnAclProfilePublishTopicException {
	return &NullableMsgVpnAclProfilePublishTopicException{value: val, isSet: true}
}

func (v NullableMsgVpnAclProfilePublishTopicException) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnAclProfilePublishTopicException) UnmarshalJSON(src []byte) error {
	v.isSet = true
