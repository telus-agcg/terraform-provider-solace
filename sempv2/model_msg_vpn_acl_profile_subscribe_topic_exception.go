...
// MsgVpnAclProfileSubscribeTopicException struct for MsgVpnAclProfileSubscribeTopicException
...
func NewMsgVpnAclProfileSubscribeTopicException() *MsgVpnAclProfileSubscribeTopicException {
	this := MsgVpnAclProfileSubscribeTopicException{}
	return &this
}
...
// GetSubscribeTopicException returns the SubscribeTopicException field value if set, zero value otherwise.
func (o *MsgVpnAclProfileSubscribeTopicException) GetSubscribeTopicException() string {
	if o == nil || o.SubscribeTopicException == nil {
		var ret string
		return ret
	}
	return *o.SubscribeTopicException
}

// GetSubscribeTopicExceptionOk returns a tuple with the SubscribeTopicException field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfileSubscribeTopicException) GetSubscribeTopicExceptionOk() (*string, bool) {
	if o == nil || o.SubscribeTopicException == nil {
		return nil, false
	}
	return o.SubscribeTopicException, true
}
...
// SetSubscribeTopicException gets a reference to the given string and assigns it to the SubscribeTopicException field.
func (o *MsgVpnAclProfileSubscribeTopicException) SetSubscribeTopicException(v string) {
	o.SubscribeTopicException = &v
}

// GetSubscribeTopicExceptionSyntax returns the SubscribeTopicExceptionSyntax field value if set, zero value otherwise.
func (o *MsgVpnAclProfileSubscribeTopicException) GetSubscribeTopicExceptionSyntax() string {
	if o == nil || o.SubscribeTopicExceptionSyntax == nil {
		var ret string
		return ret
	}
	return *o.SubscribeTopicExceptionSyntax
}

// GetSubscribeTopicExceptionSyntaxOk returns a tuple with the SubscribeTopicExceptionSyntax field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfileSubscribeTopicException) GetSubscribeTopicExceptionSyntaxOk() (*string, bool) {
	if o == nil || o.SubscribeTopicExceptionSyntax == nil {
		return nil, false
	}
	return o.SubscribeTopicExceptionSyntax, true
}
...
// SetSubscribeTopicExceptionSyntax gets a reference to the given string and assigns it to the SubscribeTopicExceptionSyntax field.
func (o *MsgVpnAclProfileSubscribeTopicException) SetSubscribeTopicExceptionSyntax(v string) {
	o.SubscribeTopicExceptionSyntax = &v
}

func (o MsgVpnAclProfileSubscribeTopicException) MarshalJSON() ([]byte, error) {
	...
	if o.SubscribeTopicException != nil {
		toSerialize["subscribeTopicException"] = o.SubscribeTopicException
	}
	if o.SubscribeTopicExceptionSyntax != nil {
		toSerialize["subscribeTopicExceptionSyntax"] = o.SubscribeTopicExceptionSyntax
	}
	return json.Marshal(toSerialize)
}

type NullableMsgVpnAclProfileSubscribeTopicException struct {
	value *MsgVpnAclProfileSubscribeTopicException
	isSet bool
}

func (v NullableMsgVpnAclProfileSubscribeTopicException) Get() *MsgVpnAclProfileSubscribeTopicException {
	return v.value
}

func (v *NullableMsgVpnAclProfileSubscribeTopicException) Set(val *MsgVpnAclProfileSubscribeTopicException) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnAclProfileSubscribeTopicException) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnAclProfileSubscribeTopicException) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnAclProfileSubscribeTopicException(val *MsgVpnAclProfileSubscribeTopicException) *NullableMsgVpnAclProfileSubscribeTopicException {
	return &NullableMsgVpnAclProfileSubscribeTopicException{value: val, isSet: true}
}

func (v NullableMsgVpnAclProfileSubscribeTopicException) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnAclProfileSubscribeTopicException) UnmarshalJSON(src []byte) error {
	v.isSet = true
