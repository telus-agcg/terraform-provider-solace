...
// DmrClusterLinkTlsTrustedCommonName struct for DmrClusterLinkTlsTrustedCommonName
...
func NewDmrClusterLinkTlsTrustedCommonName() *DmrClusterLinkTlsTrustedCommonName {
	this := DmrClusterLinkTlsTrustedCommonName{}
	return &this
}
...
func (o DmrClusterLinkTlsTrustedCommonName) MarshalJSON() ([]byte, error) {
...
type NullableDmrClusterLinkTlsTrustedCommonName struct {
	value *DmrClusterLinkTlsTrustedCommonName
	isSet bool
}

func (v NullableDmrClusterLinkTlsTrustedCommonName) Get() *DmrClusterLinkTlsTrustedCommonName {
	return v.value
}

func (v *NullableDmrClusterLinkTlsTrustedCommonName) Set(val *DmrClusterLinkTlsTrustedCommonName) {
	v.value = val
	v.isSet = true
}

func (v NullableDmrClusterLinkTlsTrustedCommonName) IsSet() bool {
	return v.isSet
}

func (v *NullableDmrClusterLinkTlsTrustedCommonName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDmrClusterLinkTlsTrustedCommonName(val *DmrClusterLinkTlsTrustedCommonName) *NullableDmrClusterLinkTlsTrustedCommonName {
	return &NullableDmrClusterLinkTlsTrustedCommonName{value: val, isSet: true}
}

func (v NullableDmrClusterLinkTlsTrustedCommonName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDmrClusterLinkTlsTrustedCommonName) UnmarshalJSON(src []byte) error {
	v.isSet = true
