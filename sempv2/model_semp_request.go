...
// SempRequest struct for SempRequest
...
func (o SempRequest) MarshalJSON() ([]byte, error) {
...
type NullableSempRequest struct {
	value *SempRequest
	isSet bool
}

func (v NullableSempRequest) Get() *SempRequest {
	return v.value
}

func (v *NullableSempRequest) Set(val *SempRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSempRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSempRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSempRequest(val *SempRequest) *NullableSempRequest {
	return &NullableSempRequest{value: val, isSet: true}
}

func (v NullableSempRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSempRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
