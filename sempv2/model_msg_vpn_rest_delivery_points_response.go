...
// MsgVpnRestDeliveryPointsResponse struct for MsgVpnRestDeliveryPointsResponse
...
func NewMsgVpnRestDeliveryPointsResponse(meta SempMeta) *MsgVpnRestDeliveryPointsResponse {
	this := MsgVpnRestDeliveryPointsResponse{}
	this.Meta = meta
	return &this
}
...
func (o *MsgVpnRestDeliveryPointsResponse) GetData() []MsgVpnRestDeliveryPoint {
	if o == nil || o.Data == nil {
		var ret []MsgVpnRestDeliveryPoint
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []MsgVpnRestDeliveryPoint and assigns it to the Data field.
...
func (o *MsgVpnRestDeliveryPointsResponse) GetLinks() []MsgVpnRestDeliveryPointLinks {
	if o == nil || o.Links == nil {
		var ret []MsgVpnRestDeliveryPointLinks
		return ret
	}
	return o.Links
}
...
// SetLinks gets a reference to the given []MsgVpnRestDeliveryPointLinks and assigns it to the Links field.
...
func (o MsgVpnRestDeliveryPointsResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnRestDeliveryPointsResponse struct {
	value *MsgVpnRestDeliveryPointsResponse
	isSet bool
}

func (v NullableMsgVpnRestDeliveryPointsResponse) Get() *MsgVpnRestDeliveryPointsResponse {
	return v.value
}

func (v *NullableMsgVpnRestDeliveryPointsResponse) Set(val *MsgVpnRestDeliveryPointsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnRestDeliveryPointsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnRestDeliveryPointsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnRestDeliveryPointsResponse(val *MsgVpnRestDeliveryPointsResponse) *NullableMsgVpnRestDeliveryPointsResponse {
	return &NullableMsgVpnRestDeliveryPointsResponse{value: val, isSet: true}
}

func (v NullableMsgVpnRestDeliveryPointsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnRestDeliveryPointsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
