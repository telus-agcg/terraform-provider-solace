...
// GetClientConnectDefaultAction returns the ClientConnectDefaultAction field value if set, zero value otherwise.
func (o *MsgVpnAclProfile) GetClientConnectDefaultAction() string {
	if o == nil || o.ClientConnectDefaultAction == nil {
		var ret string
		return ret
	}
	return *o.ClientConnectDefaultAction
}

// GetClientConnectDefaultActionOk returns a tuple with the ClientConnectDefaultAction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfile) GetClientConnectDefaultActionOk() (*string, bool) {
	if o == nil || o.ClientConnectDefaultAction == nil {
		return nil, false
	}
	return o.ClientConnectDefaultAction, true
}
...
// SetClientConnectDefaultAction gets a reference to the given string and assigns it to the ClientConnectDefaultAction field.
func (o *MsgVpnAclProfile) SetClientConnectDefaultAction(v string) {
	o.ClientConnectDefaultAction = &v
}
...
// GetPublishTopicDefaultAction returns the PublishTopicDefaultAction field value if set, zero value otherwise.
func (o *MsgVpnAclProfile) GetPublishTopicDefaultAction() string {
	if o == nil || o.PublishTopicDefaultAction == nil {
		var ret string
		return ret
	}
	return *o.PublishTopicDefaultAction
}

// GetPublishTopicDefaultActionOk returns a tuple with the PublishTopicDefaultAction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfile) GetPublishTopicDefaultActionOk() (*string, bool) {
	if o == nil || o.PublishTopicDefaultAction == nil {
		return nil, false
	}
	return o.PublishTopicDefaultAction, true
}
...
// SetPublishTopicDefaultAction gets a reference to the given string and assigns it to the PublishTopicDefaultAction field.
func (o *MsgVpnAclProfile) SetPublishTopicDefaultAction(v string) {
	o.PublishTopicDefaultAction = &v
}

// GetSubscribeShareNameDefaultAction returns the SubscribeShareNameDefaultAction field value if set, zero value otherwise.
func (o *MsgVpnAclProfile) GetSubscribeShareNameDefaultAction() string {
	if o == nil || o.SubscribeShareNameDefaultAction == nil {
		var ret string
		return ret
	}
	return *o.SubscribeShareNameDefaultAction
}

// GetSubscribeShareNameDefaultActionOk returns a tuple with the SubscribeShareNameDefaultAction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfile) GetSubscribeShareNameDefaultActionOk() (*string, bool) {
	if o == nil || o.SubscribeShareNameDefaultAction == nil {
		return nil, false
	}
	return o.SubscribeShareNameDefaultAction, true
}
...
// SetSubscribeShareNameDefaultAction gets a reference to the given string and assigns it to the SubscribeShareNameDefaultAction field.
func (o *MsgVpnAclProfile) SetSubscribeShareNameDefaultAction(v string) {
	o.SubscribeShareNameDefaultAction = &v
}

// GetSubscribeTopicDefaultAction returns the SubscribeTopicDefaultAction field value if set, zero value otherwise.
func (o *MsgVpnAclProfile) GetSubscribeTopicDefaultAction() string {
	if o == nil || o.SubscribeTopicDefaultAction == nil {
		var ret string
		return ret
	}
	return *o.SubscribeTopicDefaultAction
}

// GetSubscribeTopicDefaultActionOk returns a tuple with the SubscribeTopicDefaultAction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfile) GetSubscribeTopicDefaultActionOk() (*string, bool) {
	if o == nil || o.SubscribeTopicDefaultAction == nil {
		return nil, false
	}
	return o.SubscribeTopicDefaultAction, true
}
...
// SetSubscribeTopicDefaultAction gets a reference to the given string and assigns it to the SubscribeTopicDefaultAction field.
func (o *MsgVpnAclProfile) SetSubscribeTopicDefaultAction(v string) {
	o.SubscribeTopicDefaultAction = &v
}

func (o MsgVpnAclProfile) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.AclProfileName != nil {
		toSerialize["aclProfileName"] = o.AclProfileName
	}
	if o.ClientConnectDefaultAction != nil {
		toSerialize["clientConnectDefaultAction"] = o.ClientConnectDefaultAction
	}
	if o.MsgVpnName != nil {
		toSerialize["msgVpnName"] = o.MsgVpnName
	}
	if o.PublishTopicDefaultAction != nil {
		toSerialize["publishTopicDefaultAction"] = o.PublishTopicDefaultAction
	}
	if o.SubscribeShareNameDefaultAction != nil {
		toSerialize["subscribeShareNameDefaultAction"] = o.SubscribeShareNameDefaultAction
	}
	if o.SubscribeTopicDefaultAction != nil {
		toSerialize["subscribeTopicDefaultAction"] = o.SubscribeTopicDefaultAction
	}
	return json.Marshal(toSerialize)
}

type NullableMsgVpnAclProfile struct {
	value *MsgVpnAclProfile
	isSet bool
}

func (v NullableMsgVpnAclProfile) Get() *MsgVpnAclProfile {
	return v.value
}

func (v *NullableMsgVpnAclProfile) Set(val *MsgVpnAclProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnAclProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnAclProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnAclProfile(val *MsgVpnAclProfile) *NullableMsgVpnAclProfile {
	return &NullableMsgVpnAclProfile{value: val, isSet: true}
}

func (v NullableMsgVpnAclProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnAclProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
