...
// GetUserUri returns the UserUri field value if set, zero value otherwise.
func (o *AboutLinks) GetUserUri() string {
	if o == nil || o.UserUri == nil {
		var ret string
		return ret
	}
	return *o.UserUri
...
// GetUserUriOk returns a tuple with the UserUri field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetUserUri gets a reference to the given string and assigns it to the UserUri field.
