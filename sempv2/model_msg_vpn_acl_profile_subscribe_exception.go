...
func NewMsgVpnAclProfileSubscribeException() *MsgVpnAclProfileSubscribeException {
	this := MsgVpnAclProfileSubscribeException{}
	return &this
}
...
// GetSubscribeExceptionTopic returns the SubscribeExceptionTopic field value if set, zero value otherwise.
func (o *MsgVpnAclProfileSubscribeException) GetSubscribeExceptionTopic() string {
	if o == nil || o.SubscribeExceptionTopic == nil {
		var ret string
		return ret
	}
	return *o.SubscribeExceptionTopic
}

// GetSubscribeExceptionTopicOk returns a tuple with the SubscribeExceptionTopic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfileSubscribeException) GetSubscribeExceptionTopicOk() (*string, bool) {
	if o == nil || o.SubscribeExceptionTopic == nil {
		return nil, false
	}
	return o.SubscribeExceptionTopic, true
}
...
// SetSubscribeExceptionTopic gets a reference to the given string and assigns it to the SubscribeExceptionTopic field.
func (o *MsgVpnAclProfileSubscribeException) SetSubscribeExceptionTopic(v string) {
	o.SubscribeExceptionTopic = &v
}

// GetTopicSyntax returns the TopicSyntax field value if set, zero value otherwise.
func (o *MsgVpnAclProfileSubscribeException) GetTopicSyntax() string {
	if o == nil || o.TopicSyntax == nil {
		var ret string
		return ret
	}
	return *o.TopicSyntax
}

// GetTopicSyntaxOk returns a tuple with the TopicSyntax field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfileSubscribeException) GetTopicSyntaxOk() (*string, bool) {
	if o == nil || o.TopicSyntax == nil {
		return nil, false
	}
	return o.TopicSyntax, true
}
...
// SetTopicSyntax gets a reference to the given string and assigns it to the TopicSyntax field.
func (o *MsgVpnAclProfileSubscribeException) SetTopicSyntax(v string) {
	o.TopicSyntax = &v
}

func (o MsgVpnAclProfileSubscribeException) MarshalJSON() ([]byte, error) {
	...
	if o.SubscribeExceptionTopic != nil {
		toSerialize["subscribeExceptionTopic"] = o.SubscribeExceptionTopic
	}
	if o.TopicSyntax != nil {
		toSerialize["topicSyntax"] = o.TopicSyntax
	}
	return json.Marshal(toSerialize)
}

type NullableMsgVpnAclProfileSubscribeException struct {
	value *MsgVpnAclProfileSubscribeException
	isSet bool
}

func (v NullableMsgVpnAclProfileSubscribeException) Get() *MsgVpnAclProfileSubscribeException {
	return v.value
}

func (v *NullableMsgVpnAclProfileSubscribeException) Set(val *MsgVpnAclProfileSubscribeException) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnAclProfileSubscribeException) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnAclProfileSubscribeException) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnAclProfileSubscribeException(val *MsgVpnAclProfileSubscribeException) *NullableMsgVpnAclProfileSubscribeException {
	return &NullableMsgVpnAclProfileSubscribeException{value: val, isSet: true}
}

func (v NullableMsgVpnAclProfileSubscribeException) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnAclProfileSubscribeException) UnmarshalJSON(src []byte) error {
	v.isSet = true
