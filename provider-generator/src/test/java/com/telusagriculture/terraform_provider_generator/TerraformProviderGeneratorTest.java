 ...
 * 1) Set a break point in TerraformProviderGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class TerraformProviderGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("terraform-provider") // use this codegen library
              ...
              .setOutputDir("out/terraform-provider"); // output directory
