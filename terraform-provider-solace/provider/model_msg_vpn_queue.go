		...
		Attributes: map[string]tfsdk.Attribute{
			"access_type": {
				...
				Validators: []tfsdk.AttributeValidator{
					util.StringOneOfValidator("exclusive", "non-exclusive"),
				},
			},
			...
			"permission": {
				...
				// },
				Validators: []tfsdk.AttributeValidator{
					util.StringOneOfValidator("no-access", "read-only", "consume", "modify-topic", "delete"),
				},
			},
			"queue_name": {
				Type:        types.StringType,
			...
			"reject_msg_to_sender_on_discard_behavior": {
				...
				// },
				Validators: []tfsdk.AttributeValidator{
					util.StringOneOfValidator("always", "when-queue-enabled", "never"),
				},
			},
