...
// EventThresholdByValue struct for EventThresholdByValue
...
// GetClearValue returns the ClearValue field value if set, zero value otherwise.
func (o *EventThresholdByValue) GetClearValue() int64 {
	if o == nil || o.ClearValue == nil {
		var ret int64
		return ret
	}
	return *o.ClearValue
...
// GetClearValueOk returns a tuple with the ClearValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EventThresholdByValue) GetClearValueOk() (*int64, bool) {
	if o == nil || o.ClearValue == nil {
		return nil, false
	}
	return o.ClearValue, true
}
...
// SetClearValue gets a reference to the given int64 and assigns it to the ClearValue field.
...
// SetSetValue gets a reference to the given int64 and assigns it to the SetValue field.
func (o *EventThresholdByValue) SetSetValue(v int64) {
	o.SetValue = &v
}

func (o EventThresholdByValue) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.ClearValue != nil {
		toSerialize["clearValue"] = o.ClearValue
	}
	if o.SetValue != nil {
...
type NullableEventThresholdByValue struct {
	value *EventThresholdByValue
	isSet bool
}

func (v NullableEventThresholdByValue) Get() *EventThresholdByValue {
	return v.value
}

func (v *NullableEventThresholdByValue) Set(val *EventThresholdByValue) {
	v.value = val
	v.isSet = true
}

func (v NullableEventThresholdByValue) IsSet() bool {
	return v.isSet
}

func (v *NullableEventThresholdByValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventThresholdByValue(val *EventThresholdByValue) *NullableEventThresholdByValue {
	return &NullableEventThresholdByValue{value: val, isSet: true}
}

func (v NullableEventThresholdByValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventThresholdByValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
