...
// MsgVpnDistributedCacheClusterGlobalCachingHomeCluster struct for MsgVpnDistributedCacheClusterGlobalCachingHomeCluster
...
func NewMsgVpnDistributedCacheClusterGlobalCachingHomeCluster() *MsgVpnDistributedCacheClusterGlobalCachingHomeCluster {
	this := MsgVpnDistributedCacheClusterGlobalCachingHomeCluster{}
	return &this
}
...
func (o MsgVpnDistributedCacheClusterGlobalCachingHomeCluster) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnDistributedCacheClusterGlobalCachingHomeCluster struct {
	value *MsgVpnDistributedCacheClusterGlobalCachingHomeCluster
	isSet bool
}

func (v NullableMsgVpnDistributedCacheClusterGlobalCachingHomeCluster) Get() *MsgVpnDistributedCacheClusterGlobalCachingHomeCluster {
	return v.value
}

func (v *NullableMsgVpnDistributedCacheClusterGlobalCachingHomeCluster) Set(val *MsgVpnDistributedCacheClusterGlobalCachingHomeCluster) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnDistributedCacheClusterGlobalCachingHomeCluster) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnDistributedCacheClusterGlobalCachingHomeCluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnDistributedCacheClusterGlobalCachingHomeCluster(val *MsgVpnDistributedCacheClusterGlobalCachingHomeCluster) *NullableMsgVpnDistributedCacheClusterGlobalCachingHomeCluster {
	return &NullableMsgVpnDistributedCacheClusterGlobalCachingHomeCluster{value: val, isSet: true}
}

func (v NullableMsgVpnDistributedCacheClusterGlobalCachingHomeCluster) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnDistributedCacheClusterGlobalCachingHomeCluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
