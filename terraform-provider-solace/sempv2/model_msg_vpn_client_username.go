...
// GetGuaranteedEndpointPermissionOverrideEnabled returns the GuaranteedEndpointPermissionOverrideEnabled field value if set, zero value otherwise.
func (o *MsgVpnClientUsername) GetGuaranteedEndpointPermissionOverrideEnabled() bool {
	if o == nil || o.GuaranteedEndpointPermissionOverrideEnabled == nil {
		var ret bool
		return ret
	}
	return *o.GuaranteedEndpointPermissionOverrideEnabled
}

// GetGuaranteedEndpointPermissionOverrideEnabledOk returns a tuple with the GuaranteedEndpointPermissionOverrideEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnClientUsername) GetGuaranteedEndpointPermissionOverrideEnabledOk() (*bool, bool) {
	if o == nil || o.GuaranteedEndpointPermissionOverrideEnabled == nil {
		return nil, false
	}
	return o.GuaranteedEndpointPermissionOverrideEnabled, true
}
...
// SetGuaranteedEndpointPermissionOverrideEnabled gets a reference to the given bool and assigns it to the GuaranteedEndpointPermissionOverrideEnabled field.
func (o *MsgVpnClientUsername) SetGuaranteedEndpointPermissionOverrideEnabled(v bool) {
	o.GuaranteedEndpointPermissionOverrideEnabled = &v
}
...
// GetSubscriptionManagerEnabled returns the SubscriptionManagerEnabled field value if set, zero value otherwise.
func (o *MsgVpnClientUsername) GetSubscriptionManagerEnabled() bool {
	if o == nil || o.SubscriptionManagerEnabled == nil {
		var ret bool
		return ret
	}
	return *o.SubscriptionManagerEnabled
}

// GetSubscriptionManagerEnabledOk returns a tuple with the SubscriptionManagerEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnClientUsername) GetSubscriptionManagerEnabledOk() (*bool, bool) {
	if o == nil || o.SubscriptionManagerEnabled == nil {
		return nil, false
	}
	return o.SubscriptionManagerEnabled, true
}
...
// SetSubscriptionManagerEnabled gets a reference to the given bool and assigns it to the SubscriptionManagerEnabled field.
func (o *MsgVpnClientUsername) SetSubscriptionManagerEnabled(v bool) {
	o.SubscriptionManagerEnabled = &v
}

func (o MsgVpnClientUsername) MarshalJSON() ([]byte, error) {
	...
	if o.GuaranteedEndpointPermissionOverrideEnabled != nil {
		toSerialize["guaranteedEndpointPermissionOverrideEnabled"] = o.GuaranteedEndpointPermissionOverrideEnabled
	}
	if o.MsgVpnName != nil {
	...
	if o.SubscriptionManagerEnabled != nil {
		toSerialize["subscriptionManagerEnabled"] = o.SubscriptionManagerEnabled
	}
	return json.Marshal(toSerialize)
}

type NullableMsgVpnClientUsername struct {
	value *MsgVpnClientUsername
	isSet bool
}

func (v NullableMsgVpnClientUsername) Get() *MsgVpnClientUsername {
	return v.value
}

func (v *NullableMsgVpnClientUsername) Set(val *MsgVpnClientUsername) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnClientUsername) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnClientUsername) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnClientUsername(val *MsgVpnClientUsername) *NullableMsgVpnClientUsername {
	return &NullableMsgVpnClientUsername{value: val, isSet: true}
}

func (v NullableMsgVpnClientUsername) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnClientUsername) UnmarshalJSON(src []byte) error {
	v.isSet = true
