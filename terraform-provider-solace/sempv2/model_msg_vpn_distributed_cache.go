...
// MsgVpnDistributedCache struct for MsgVpnDistributedCache
type MsgVpnDistributedCache struct {
	...
	// The scheduled delete message time(s), specified as \"hourly\" or a comma-separated list of 24-hour times in the form hh:mm, or h:mm. There must be no spaces, and times (up to 4) must be in sorted order from 0:00 to 23:59. Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `\"\"`.
...
// GetScheduledDeleteMsgDayList returns the ScheduledDeleteMsgDayList field value if set, zero value otherwise.
func (o *MsgVpnDistributedCache) GetScheduledDeleteMsgDayList() string {
	if o == nil || o.ScheduledDeleteMsgDayList == nil {
		var ret string
		return ret
	}
	return *o.ScheduledDeleteMsgDayList
}

// GetScheduledDeleteMsgDayListOk returns a tuple with the ScheduledDeleteMsgDayList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnDistributedCache) GetScheduledDeleteMsgDayListOk() (*string, bool) {
	if o == nil || o.ScheduledDeleteMsgDayList == nil {
		return nil, false
	}
	return o.ScheduledDeleteMsgDayList, true
}
...
// SetScheduledDeleteMsgDayList gets a reference to the given string and assigns it to the ScheduledDeleteMsgDayList field.
func (o *MsgVpnDistributedCache) SetScheduledDeleteMsgDayList(v string) {
	o.ScheduledDeleteMsgDayList = &v
}

// GetScheduledDeleteMsgTimeList returns the ScheduledDeleteMsgTimeList field value if set, zero value otherwise.
func (o *MsgVpnDistributedCache) GetScheduledDeleteMsgTimeList() string {
	if o == nil || o.ScheduledDeleteMsgTimeList == nil {
		var ret string
		return ret
	}
	return *o.ScheduledDeleteMsgTimeList
}

// GetScheduledDeleteMsgTimeListOk returns a tuple with the ScheduledDeleteMsgTimeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnDistributedCache) GetScheduledDeleteMsgTimeListOk() (*string, bool) {
	if o == nil || o.ScheduledDeleteMsgTimeList == nil {
		return nil, false
	}
	return o.ScheduledDeleteMsgTimeList, true
}
...
// SetScheduledDeleteMsgTimeList gets a reference to the given string and assigns it to the ScheduledDeleteMsgTimeList field.
func (o *MsgVpnDistributedCache) SetScheduledDeleteMsgTimeList(v string) {
	o.ScheduledDeleteMsgTimeList = &v
}

func (o MsgVpnDistributedCache) MarshalJSON() ([]byte, error) {
	...
	if o.ScheduledDeleteMsgDayList != nil {
		toSerialize["scheduledDeleteMsgDayList"] = o.ScheduledDeleteMsgDayList
	}
	if o.ScheduledDeleteMsgTimeList != nil {
		toSerialize["scheduledDeleteMsgTimeList"] = o.ScheduledDeleteMsgTimeList
	}
	return json.Marshal(toSerialize)
}

type NullableMsgVpnDistributedCache struct {
	value *MsgVpnDistributedCache
	isSet bool
}

func (v NullableMsgVpnDistributedCache) Get() *MsgVpnDistributedCache {
	return v.value
}

func (v *NullableMsgVpnDistributedCache) Set(val *MsgVpnDistributedCache) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnDistributedCache) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnDistributedCache) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnDistributedCache(val *MsgVpnDistributedCache) *NullableMsgVpnDistributedCache {
	return &NullableMsgVpnDistributedCache{value: val, isSet: true}
}

func (v NullableMsgVpnDistributedCache) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnDistributedCache) UnmarshalJSON(src []byte) error {
	v.isSet = true
