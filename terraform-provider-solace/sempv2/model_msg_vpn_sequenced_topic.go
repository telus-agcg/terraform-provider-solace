...
// MsgVpnSequencedTopic struct for MsgVpnSequencedTopic
...
// GetSequencedTopic returns the SequencedTopic field value if set, zero value otherwise.
func (o *MsgVpnSequencedTopic) GetSequencedTopic() string {
	if o == nil || o.SequencedTopic == nil {
		var ret string
		return ret
	}
	return *o.SequencedTopic
}

// GetSequencedTopicOk returns a tuple with the SequencedTopic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnSequencedTopic) GetSequencedTopicOk() (*string, bool) {
	if o == nil || o.SequencedTopic == nil {
		return nil, false
	}
	return o.SequencedTopic, true
}
...
// SetSequencedTopic gets a reference to the given string and assigns it to the SequencedTopic field.
func (o *MsgVpnSequencedTopic) SetSequencedTopic(v string) {
	o.SequencedTopic = &v
}

func (o MsgVpnSequencedTopic) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.MsgVpnName != nil {
		toSerialize["msgVpnName"] = o.MsgVpnName
	}
	if o.SequencedTopic != nil {
		toSerialize["sequencedTopic"] = o.SequencedTopic
	}
	return json.Marshal(toSerialize)
}

type NullableMsgVpnSequencedTopic struct {
	value *MsgVpnSequencedTopic
	isSet bool
}

func (v NullableMsgVpnSequencedTopic) Get() *MsgVpnSequencedTopic {
	return v.value
}

func (v *NullableMsgVpnSequencedTopic) Set(val *MsgVpnSequencedTopic) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnSequencedTopic) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnSequencedTopic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnSequencedTopic(val *MsgVpnSequencedTopic) *NullableMsgVpnSequencedTopic {
	return &NullableMsgVpnSequencedTopic{value: val, isSet: true}
}

func (v NullableMsgVpnSequencedTopic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnSequencedTopic) UnmarshalJSON(src []byte) error {
	v.isSet = true
