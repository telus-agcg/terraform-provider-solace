...
// GetOauthProfilesUri returns the OauthProfilesUri field value if set, zero value otherwise.
func (o *BrokerLinks) GetOauthProfilesUri() string {
	if o == nil || o.OauthProfilesUri == nil {
		var ret string
		return ret
	}
	return *o.OauthProfilesUri
}

// GetOauthProfilesUriOk returns a tuple with the OauthProfilesUri field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BrokerLinks) GetOauthProfilesUriOk() (*string, bool) {
	if o == nil || o.OauthProfilesUri == nil {
		return nil, false
	}
	return o.OauthProfilesUri, true
}

// HasOauthProfilesUri returns a boolean if a field has been set.
func (o *BrokerLinks) HasOauthProfilesUri() bool {
	if o != nil && o.OauthProfilesUri != nil {
		return true
	}
...
// SetOauthProfilesUri gets a reference to the given string and assigns it to the OauthProfilesUri field.
func (o *BrokerLinks) SetOauthProfilesUri(v string) {
	o.OauthProfilesUri = &v
}

// GetSystemInformationUri returns the SystemInformationUri field value if set, zero value otherwise.
func (o *BrokerLinks) GetSystemInformationUri() string {
	if o == nil || o.SystemInformationUri == nil {
		var ret string
		return ret
	}
	return *o.SystemInformationUri
}

// GetSystemInformationUriOk returns a tuple with the SystemInformationUri field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BrokerLinks) GetSystemInformationUriOk() (*string, bool) {
	if o == nil || o.SystemInformationUri == nil {
		return nil, false
	}
	return o.SystemInformationUri, true
}
...
// SetSystemInformationUri gets a reference to the given string and assigns it to the SystemInformationUri field.
func (o *BrokerLinks) SetSystemInformationUri(v string) {
	o.SystemInformationUri = &v
}
...
func (o BrokerLinks) MarshalJSON() ([]byte, error) {
	...
	if o.OauthProfilesUri != nil {
		toSerialize["oauthProfilesUri"] = o.OauthProfilesUri
	}
	if o.SystemInformationUri != nil {
		toSerialize["systemInformationUri"] = o.SystemInformationUri
	}
	if o.Uri != nil {
