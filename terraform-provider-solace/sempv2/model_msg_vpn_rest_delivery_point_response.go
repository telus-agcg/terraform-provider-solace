...
// MsgVpnRestDeliveryPointResponse struct for MsgVpnRestDeliveryPointResponse
...
func NewMsgVpnRestDeliveryPointResponse(meta SempMeta) *MsgVpnRestDeliveryPointResponse {
	this := MsgVpnRestDeliveryPointResponse{}
	this.Meta = meta
	return &this
}
...
func (o MsgVpnRestDeliveryPointResponse) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnRestDeliveryPointResponse struct {
	value *MsgVpnRestDeliveryPointResponse
	isSet bool
}

func (v NullableMsgVpnRestDeliveryPointResponse) Get() *MsgVpnRestDeliveryPointResponse {
	return v.value
}

func (v *NullableMsgVpnRestDeliveryPointResponse) Set(val *MsgVpnRestDeliveryPointResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnRestDeliveryPointResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnRestDeliveryPointResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnRestDeliveryPointResponse(val *MsgVpnRestDeliveryPointResponse) *NullableMsgVpnRestDeliveryPointResponse {
	return &NullableMsgVpnRestDeliveryPointResponse{value: val, isSet: true}
}

func (v NullableMsgVpnRestDeliveryPointResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnRestDeliveryPointResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
