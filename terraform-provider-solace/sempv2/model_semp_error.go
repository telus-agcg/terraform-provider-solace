...
// SempError struct for SempError
...
func (o SempError) MarshalJSON() ([]byte, error) {
...
type NullableSempError struct {
	value *SempError
	isSet bool
}

func (v NullableSempError) Get() *SempError {
	return v.value
}

func (v *NullableSempError) Set(val *SempError) {
	v.value = val
	v.isSet = true
}

func (v NullableSempError) IsSet() bool {
	return v.isSet
}

func (v *NullableSempError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSempError(val *SempError) *NullableSempError {
	return &NullableSempError{value: val, isSet: true}
}

func (v NullableSempError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSempError) UnmarshalJSON(src []byte) error {
	v.isSet = true
