...
// MsgVpnDmrBridge struct for MsgVpnDmrBridge
...
func (o MsgVpnDmrBridge) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnDmrBridge struct {
	value *MsgVpnDmrBridge
	isSet bool
}

func (v NullableMsgVpnDmrBridge) Get() *MsgVpnDmrBridge {
	return v.value
}

func (v *NullableMsgVpnDmrBridge) Set(val *MsgVpnDmrBridge) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnDmrBridge) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnDmrBridge) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnDmrBridge(val *MsgVpnDmrBridge) *NullableMsgVpnDmrBridge {
	return &NullableMsgVpnDmrBridge{value: val, isSet: true}
}

func (v NullableMsgVpnDmrBridge) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnDmrBridge) UnmarshalJSON(src []byte) error {
	v.isSet = true
