...
func NewMsgVpnAclProfilePublishException() *MsgVpnAclProfilePublishException {
	this := MsgVpnAclProfilePublishException{}
	return &this
}
...
// GetPublishExceptionTopic returns the PublishExceptionTopic field value if set, zero value otherwise.
func (o *MsgVpnAclProfilePublishException) GetPublishExceptionTopic() string {
	if o == nil || o.PublishExceptionTopic == nil {
		var ret string
		return ret
	}
	return *o.PublishExceptionTopic
}

// GetPublishExceptionTopicOk returns a tuple with the PublishExceptionTopic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfilePublishException) GetPublishExceptionTopicOk() (*string, bool) {
	if o == nil || o.PublishExceptionTopic == nil {
		return nil, false
	}
	return o.PublishExceptionTopic, true
}
...
// SetPublishExceptionTopic gets a reference to the given string and assigns it to the PublishExceptionTopic field.
func (o *MsgVpnAclProfilePublishException) SetPublishExceptionTopic(v string) {
	o.PublishExceptionTopic = &v
}
...
func (o MsgVpnAclProfilePublishException) MarshalJSON() ([]byte, error) {
	...
	if o.PublishExceptionTopic != nil {
		toSerialize["publishExceptionTopic"] = o.PublishExceptionTopic
	}
...
type NullableMsgVpnAclProfilePublishException struct {
	value *MsgVpnAclProfilePublishException
	isSet bool
}

func (v NullableMsgVpnAclProfilePublishException) Get() *MsgVpnAclProfilePublishException {
	return v.value
}

func (v *NullableMsgVpnAclProfilePublishException) Set(val *MsgVpnAclProfilePublishException) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnAclProfilePublishException) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnAclProfilePublishException) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnAclProfilePublishException(val *MsgVpnAclProfilePublishException) *NullableMsgVpnAclProfilePublishException {
	return &NullableMsgVpnAclProfilePublishException{value: val, isSet: true}
}

func (v NullableMsgVpnAclProfilePublishException) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnAclProfilePublishException) UnmarshalJSON(src []byte) error {
	v.isSet = true
