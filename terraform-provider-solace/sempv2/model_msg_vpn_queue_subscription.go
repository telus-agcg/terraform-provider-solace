...
func (o MsgVpnQueueSubscription) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnQueueSubscription struct {
	value *MsgVpnQueueSubscription
	isSet bool
}

func (v NullableMsgVpnQueueSubscription) Get() *MsgVpnQueueSubscription {
	return v.value
}

func (v *NullableMsgVpnQueueSubscription) Set(val *MsgVpnQueueSubscription) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnQueueSubscription) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnQueueSubscription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnQueueSubscription(val *MsgVpnQueueSubscription) *NullableMsgVpnQueueSubscription {
	return &NullableMsgVpnQueueSubscription{value: val, isSet: true}
}

func (v NullableMsgVpnQueueSubscription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnQueueSubscription) UnmarshalJSON(src []byte) error {
	v.isSet = true
