...
// AboutUser struct for AboutUser
...
// GetGlobalAccessLevel returns the GlobalAccessLevel field value if set, zero value otherwise.
func (o *AboutUser) GetGlobalAccessLevel() string {
	if o == nil || o.GlobalAccessLevel == nil {
		var ret string
		return ret
	}
	return *o.GlobalAccessLevel
}

// GetGlobalAccessLevelOk returns a tuple with the GlobalAccessLevel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AboutUser) GetGlobalAccessLevelOk() (*string, bool) {
	if o == nil || o.GlobalAccessLevel == nil {
		return nil, false
	}
	return o.GlobalAccessLevel, true
}
...
// SetGlobalAccessLevel gets a reference to the given string and assigns it to the GlobalAccessLevel field.
func (o *AboutUser) SetGlobalAccessLevel(v string) {
	o.GlobalAccessLevel = &v
}

// GetSessionActive returns the SessionActive field value if set, zero value otherwise.
func (o *AboutUser) GetSessionActive() bool {
	if o == nil || o.SessionActive == nil {
		var ret bool
		return ret
	}
	return *o.SessionActive
}

// GetSessionActiveOk returns a tuple with the SessionActive field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AboutUser) GetSessionActiveOk() (*bool, bool) {
	if o == nil || o.SessionActive == nil {
		return nil, false
	}
	return o.SessionActive, true
}

// HasSessionActive returns a boolean if a field has been set.
func (o *AboutUser) HasSessionActive() bool {
	if o != nil && o.SessionActive != nil {
		return true
	}
...
// SetSessionActive gets a reference to the given bool and assigns it to the SessionActive field.
func (o *AboutUser) SetSessionActive(v bool) {
	o.SessionActive = &v
}

// GetSessionCreateTime returns the SessionCreateTime field value if set, zero value otherwise.
func (o *AboutUser) GetSessionCreateTime() int32 {
	if o == nil || o.SessionCreateTime == nil {
		var ret int32
		return ret
	}
	return *o.SessionCreateTime
}

// GetSessionCreateTimeOk returns a tuple with the SessionCreateTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AboutUser) GetSessionCreateTimeOk() (*int32, bool) {
	if o == nil || o.SessionCreateTime == nil {
		return nil, false
	}
	return o.SessionCreateTime, true
}
...
// SetSessionCreateTime gets a reference to the given int32 and assigns it to the SessionCreateTime field.
func (o *AboutUser) SetSessionCreateTime(v int32) {
	o.SessionCreateTime = &v
}

// GetSessionCurrentTime returns the SessionCurrentTime field value if set, zero value otherwise.
func (o *AboutUser) GetSessionCurrentTime() int32 {
	if o == nil || o.SessionCurrentTime == nil {
		var ret int32
		return ret
	}
	return *o.SessionCurrentTime
}

// GetSessionCurrentTimeOk returns a tuple with the SessionCurrentTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AboutUser) GetSessionCurrentTimeOk() (*int32, bool) {
	if o == nil || o.SessionCurrentTime == nil {
		return nil, false
	}
	return o.SessionCurrentTime, true
}
...
// SetSessionCurrentTime gets a reference to the given int32 and assigns it to the SessionCurrentTime field.
func (o *AboutUser) SetSessionCurrentTime(v int32) {
	o.SessionCurrentTime = &v
}

// GetSessionHardExpiryTime returns the SessionHardExpiryTime field value if set, zero value otherwise.
func (o *AboutUser) GetSessionHardExpiryTime() int32 {
	if o == nil || o.SessionHardExpiryTime == nil {
		var ret int32
		return ret
	}
	return *o.SessionHardExpiryTime
}

// GetSessionHardExpiryTimeOk returns a tuple with the SessionHardExpiryTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AboutUser) GetSessionHardExpiryTimeOk() (*int32, bool) {
	if o == nil || o.SessionHardExpiryTime == nil {
		return nil, false
	}
	return o.SessionHardExpiryTime, true
}
...
// SetSessionHardExpiryTime gets a reference to the given int32 and assigns it to the SessionHardExpiryTime field.
func (o *AboutUser) SetSessionHardExpiryTime(v int32) {
	o.SessionHardExpiryTime = &v
}
...
// GetSessionIdleExpiryTime returns the SessionIdleExpiryTime field value if set, zero value otherwise.
func (o *AboutUser) GetSessionIdleExpiryTime() int32 {
	if o == nil || o.SessionIdleExpiryTime == nil {
		var ret int32
		return ret
	}
	return *o.SessionIdleExpiryTime
}

// GetSessionIdleExpiryTimeOk returns a tuple with the SessionIdleExpiryTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AboutUser) GetSessionIdleExpiryTimeOk() (*int32, bool) {
	if o == nil || o.SessionIdleExpiryTime == nil {
		return nil, false
	}
	return o.SessionIdleExpiryTime, true
}
...
// SetSessionIdleExpiryTime gets a reference to the given int32 and assigns it to the SessionIdleExpiryTime field.
func (o *AboutUser) SetSessionIdleExpiryTime(v int32) {
	o.SessionIdleExpiryTime = &v
}
...
func (o AboutUser) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.GlobalAccessLevel != nil {
		toSerialize["globalAccessLevel"] = o.GlobalAccessLevel
	}
	if o.SessionActive != nil {
		toSerialize["sessionActive"] = o.SessionActive
	}
	if o.SessionCreateTime != nil {
		toSerialize["sessionCreateTime"] = o.SessionCreateTime
	}
	if o.SessionCurrentTime != nil {
		toSerialize["sessionCurrentTime"] = o.SessionCurrentTime
	}
	if o.SessionHardExpiryTime != nil {
		toSerialize["sessionHardExpiryTime"] = o.SessionHardExpiryTime
	}
	if o.SessionId != nil {
		toSerialize["sessionId"] = o.SessionId
	}
	if o.SessionIdleExpiryTime != nil {
		toSerialize["sessionIdleExpiryTime"] = o.SessionIdleExpiryTime
	}
	if o.Username != nil {
...
type NullableAboutUser struct {
	value *AboutUser
	isSet bool
}

func (v NullableAboutUser) Get() *AboutUser {
	return v.value
}

func (v *NullableAboutUser) Set(val *AboutUser) {
	v.value = val
	v.isSet = true
}

func (v NullableAboutUser) IsSet() bool {
	return v.isSet
}

func (v *NullableAboutUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAboutUser(val *AboutUser) *NullableAboutUser {
	return &NullableAboutUser{value: val, isSet: true}
}

func (v NullableAboutUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAboutUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
