...
// VirtualHostname struct for VirtualHostname
...
func (o VirtualHostname) MarshalJSON() ([]byte, error) {
...
type NullableVirtualHostname struct {
	value *VirtualHostname
	isSet bool
}

func (v NullableVirtualHostname) Get() *VirtualHostname {
	return v.value
}

func (v *NullableVirtualHostname) Set(val *VirtualHostname) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualHostname) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualHostname) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualHostname(val *VirtualHostname) *NullableVirtualHostname {
	return &NullableVirtualHostname{value: val, isSet: true}
}

func (v NullableVirtualHostname) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualHostname) UnmarshalJSON(src []byte) error {
	v.isSet = true
