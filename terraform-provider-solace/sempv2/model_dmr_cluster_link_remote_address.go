...
// DmrClusterLinkRemoteAddress struct for DmrClusterLinkRemoteAddress
...
func NewDmrClusterLinkRemoteAddress() *DmrClusterLinkRemoteAddress {
	this := DmrClusterLinkRemoteAddress{}
	return &this
}
...
func (o DmrClusterLinkRemoteAddress) MarshalJSON() ([]byte, error) {
...
type NullableDmrClusterLinkRemoteAddress struct {
	value *DmrClusterLinkRemoteAddress
	isSet bool
}

func (v NullableDmrClusterLinkRemoteAddress) Get() *DmrClusterLinkRemoteAddress {
	return v.value
}

func (v *NullableDmrClusterLinkRemoteAddress) Set(val *DmrClusterLinkRemoteAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableDmrClusterLinkRemoteAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableDmrClusterLinkRemoteAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDmrClusterLinkRemoteAddress(val *DmrClusterLinkRemoteAddress) *NullableDmrClusterLinkRemoteAddress {
	return &NullableDmrClusterLinkRemoteAddress{value: val, isSet: true}
}

func (v NullableDmrClusterLinkRemoteAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDmrClusterLinkRemoteAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
