...
// SystemInformationResponse struct for SystemInformationResponse
...
func NewSystemInformationResponse(meta SempMeta) *SystemInformationResponse {
	this := SystemInformationResponse{}
	this.Meta = meta
	return &this
}
...
// SetData gets a reference to the given SystemInformation and assigns it to the Data field.
...
func (o *SystemInformationResponse) GetLinks() SystemInformationLinks {
	if o == nil || o.Links == nil {
		var ret SystemInformationLinks
		return ret
	}
	return *o.Links
}
...
// SetLinks gets a reference to the given SystemInformationLinks and assigns it to the Links field.
...
func (o SystemInformationResponse) MarshalJSON() ([]byte, error) {
...
type NullableSystemInformationResponse struct {
	value *SystemInformationResponse
	isSet bool
}

func (v NullableSystemInformationResponse) Get() *SystemInformationResponse {
	return v.value
}

func (v *NullableSystemInformationResponse) Set(val *SystemInformationResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemInformationResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemInformationResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemInformationResponse(val *SystemInformationResponse) *NullableSystemInformationResponse {
	return &NullableSystemInformationResponse{value: val, isSet: true}
}

func (v NullableSystemInformationResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemInformationResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
