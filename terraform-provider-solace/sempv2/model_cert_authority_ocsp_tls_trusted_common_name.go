...
// CertAuthorityOcspTlsTrustedCommonName struct for CertAuthorityOcspTlsTrustedCommonName
...
func NewCertAuthorityOcspTlsTrustedCommonName() *CertAuthorityOcspTlsTrustedCommonName {
	this := CertAuthorityOcspTlsTrustedCommonName{}
	return &this
}
...
func (o CertAuthorityOcspTlsTrustedCommonName) MarshalJSON() ([]byte, error) {
...
type NullableCertAuthorityOcspTlsTrustedCommonName struct {
	value *CertAuthorityOcspTlsTrustedCommonName
	isSet bool
}

func (v NullableCertAuthorityOcspTlsTrustedCommonName) Get() *CertAuthorityOcspTlsTrustedCommonName {
	return v.value
}

func (v *NullableCertAuthorityOcspTlsTrustedCommonName) Set(val *CertAuthorityOcspTlsTrustedCommonName) {
	v.value = val
	v.isSet = true
}

func (v NullableCertAuthorityOcspTlsTrustedCommonName) IsSet() bool {
	return v.isSet
}

func (v *NullableCertAuthorityOcspTlsTrustedCommonName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertAuthorityOcspTlsTrustedCommonName(val *CertAuthorityOcspTlsTrustedCommonName) *NullableCertAuthorityOcspTlsTrustedCommonName {
	return &NullableCertAuthorityOcspTlsTrustedCommonName{value: val, isSet: true}
}

func (v NullableCertAuthorityOcspTlsTrustedCommonName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertAuthorityOcspTlsTrustedCommonName) UnmarshalJSON(src []byte) error {
	v.isSet = true
