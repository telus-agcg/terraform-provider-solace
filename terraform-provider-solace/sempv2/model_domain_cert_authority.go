...
// DomainCertAuthority struct for DomainCertAuthority
...
func (o DomainCertAuthority) MarshalJSON() ([]byte, error) {
...
type NullableDomainCertAuthority struct {
	value *DomainCertAuthority
	isSet bool
}

func (v NullableDomainCertAuthority) Get() *DomainCertAuthority {
	return v.value
}

func (v *NullableDomainCertAuthority) Set(val *DomainCertAuthority) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainCertAuthority) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainCertAuthority) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainCertAuthority(val *DomainCertAuthority) *NullableDomainCertAuthority {
	return &NullableDomainCertAuthority{value: val, isSet: true}
}

func (v NullableDomainCertAuthority) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainCertAuthority) UnmarshalJSON(src []byte) error {
	v.isSet = true
