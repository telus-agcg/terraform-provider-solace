...
// AboutUserLinks struct for AboutUserLinks
...
func (o AboutUserLinks) MarshalJSON() ([]byte, error) {
...
type NullableAboutUserLinks struct {
	value *AboutUserLinks
	isSet bool
}

func (v NullableAboutUserLinks) Get() *AboutUserLinks {
	return v.value
}

func (v *NullableAboutUserLinks) Set(val *AboutUserLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableAboutUserLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableAboutUserLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAboutUserLinks(val *AboutUserLinks) *NullableAboutUserLinks {
	return &NullableAboutUserLinks{value: val, isSet: true}
}

func (v NullableAboutUserLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAboutUserLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
