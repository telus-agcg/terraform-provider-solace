...
// MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim struct for MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim
...
func NewMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim() *MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim {
	this := MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim{}
	return &this
}
...
// GetOauthJwtClaimName returns the OauthJwtClaimName field value if set, zero value otherwise.
func (o *MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) GetOauthJwtClaimName() string {
	if o == nil || o.OauthJwtClaimName == nil {
		var ret string
		return ret
	}
	return *o.OauthJwtClaimName
}

// GetOauthJwtClaimNameOk returns a tuple with the OauthJwtClaimName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) GetOauthJwtClaimNameOk() (*string, bool) {
	if o == nil || o.OauthJwtClaimName == nil {
		return nil, false
	}
	return o.OauthJwtClaimName, true
}
...
// SetOauthJwtClaimName gets a reference to the given string and assigns it to the OauthJwtClaimName field.
func (o *MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) SetOauthJwtClaimName(v string) {
	o.OauthJwtClaimName = &v
}

// GetOauthJwtClaimValue returns the OauthJwtClaimValue field value if set, zero value otherwise.
func (o *MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) GetOauthJwtClaimValue() string {
	if o == nil || o.OauthJwtClaimValue == nil {
		var ret string
		return ret
	}
	return *o.OauthJwtClaimValue
}

// GetOauthJwtClaimValueOk returns a tuple with the OauthJwtClaimValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) GetOauthJwtClaimValueOk() (*string, bool) {
	if o == nil || o.OauthJwtClaimValue == nil {
		return nil, false
	}
	return o.OauthJwtClaimValue, true
}
...
// SetOauthJwtClaimValue gets a reference to the given string and assigns it to the OauthJwtClaimValue field.
func (o *MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) SetOauthJwtClaimValue(v string) {
	o.OauthJwtClaimValue = &v
}
...
func (o MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.MsgVpnName != nil {
		toSerialize["msgVpnName"] = o.MsgVpnName
	}
	if o.OauthJwtClaimName != nil {
		toSerialize["oauthJwtClaimName"] = o.OauthJwtClaimName
	}
	if o.OauthJwtClaimValue != nil {
		toSerialize["oauthJwtClaimValue"] = o.OauthJwtClaimValue
	}
...
type NullableMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim struct {
	value *MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim
	isSet bool
}

func (v NullableMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) Get() *MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim {
	return v.value
}

func (v *NullableMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) Set(val *MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim(val *MsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) *NullableMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim {
	return &NullableMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim{value: val, isSet: true}
}

func (v NullableMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim) UnmarshalJSON(src []byte) error {
	v.isSet = true
