...
// MsgVpnDistributedCacheClusterTopic struct for MsgVpnDistributedCacheClusterTopic
...
func NewMsgVpnDistributedCacheClusterTopic() *MsgVpnDistributedCacheClusterTopic {
	this := MsgVpnDistributedCacheClusterTopic{}
	return &this
}
...
func (o MsgVpnDistributedCacheClusterTopic) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnDistributedCacheClusterTopic struct {
	value *MsgVpnDistributedCacheClusterTopic
	isSet bool
}

func (v NullableMsgVpnDistributedCacheClusterTopic) Get() *MsgVpnDistributedCacheClusterTopic {
	return v.value
}

func (v *NullableMsgVpnDistributedCacheClusterTopic) Set(val *MsgVpnDistributedCacheClusterTopic) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnDistributedCacheClusterTopic) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnDistributedCacheClusterTopic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnDistributedCacheClusterTopic(val *MsgVpnDistributedCacheClusterTopic) *NullableMsgVpnDistributedCacheClusterTopic {
	return &NullableMsgVpnDistributedCacheClusterTopic{value: val, isSet: true}
}

func (v NullableMsgVpnDistributedCacheClusterTopic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnDistributedCacheClusterTopic) UnmarshalJSON(src []byte) error {
	v.isSet = true
