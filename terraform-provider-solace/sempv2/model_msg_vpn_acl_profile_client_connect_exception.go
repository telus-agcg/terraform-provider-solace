...
func NewMsgVpnAclProfileClientConnectException() *MsgVpnAclProfileClientConnectException {
	this := MsgVpnAclProfileClientConnectException{}
	return &this
}
...
// GetClientConnectExceptionAddress returns the ClientConnectExceptionAddress field value if set, zero value otherwise.
func (o *MsgVpnAclProfileClientConnectException) GetClientConnectExceptionAddress() string {
	if o == nil || o.ClientConnectExceptionAddress == nil {
		var ret string
		return ret
	}
	return *o.ClientConnectExceptionAddress
}

// GetClientConnectExceptionAddressOk returns a tuple with the ClientConnectExceptionAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfileClientConnectException) GetClientConnectExceptionAddressOk() (*string, bool) {
	if o == nil || o.ClientConnectExceptionAddress == nil {
		return nil, false
	}
	return o.ClientConnectExceptionAddress, true
}
...
// SetClientConnectExceptionAddress gets a reference to the given string and assigns it to the ClientConnectExceptionAddress field.
func (o *MsgVpnAclProfileClientConnectException) SetClientConnectExceptionAddress(v string) {
	o.ClientConnectExceptionAddress = &v
}
...
func (o MsgVpnAclProfileClientConnectException) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.AclProfileName != nil {
		toSerialize["aclProfileName"] = o.AclProfileName
	}
	if o.ClientConnectExceptionAddress != nil {
		toSerialize["clientConnectExceptionAddress"] = o.ClientConnectExceptionAddress
	}
	if o.MsgVpnName != nil {
...
type NullableMsgVpnAclProfileClientConnectException struct {
	value *MsgVpnAclProfileClientConnectException
	isSet bool
}

func (v NullableMsgVpnAclProfileClientConnectException) Get() *MsgVpnAclProfileClientConnectException {
	return v.value
}

func (v *NullableMsgVpnAclProfileClientConnectException) Set(val *MsgVpnAclProfileClientConnectException) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnAclProfileClientConnectException) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnAclProfileClientConnectException) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnAclProfileClientConnectException(val *MsgVpnAclProfileClientConnectException) *NullableMsgVpnAclProfileClientConnectException {
	return &NullableMsgVpnAclProfileClientConnectException{value: val, isSet: true}
}

func (v NullableMsgVpnAclProfileClientConnectException) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnAclProfileClientConnectException) UnmarshalJSON(src []byte) error {
	v.isSet = true
