...
// MsgVpnAclProfileSubscribeShareNameException struct for MsgVpnAclProfileSubscribeShareNameException
...
func NewMsgVpnAclProfileSubscribeShareNameException() *MsgVpnAclProfileSubscribeShareNameException {
	this := MsgVpnAclProfileSubscribeShareNameException{}
	return &this
}
...
// GetSubscribeShareNameException returns the SubscribeShareNameException field value if set, zero value otherwise.
func (o *MsgVpnAclProfileSubscribeShareNameException) GetSubscribeShareNameException() string {
	if o == nil || o.SubscribeShareNameException == nil {
		var ret string
		return ret
	}
	return *o.SubscribeShareNameException
}

// GetSubscribeShareNameExceptionOk returns a tuple with the SubscribeShareNameException field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfileSubscribeShareNameException) GetSubscribeShareNameExceptionOk() (*string, bool) {
	if o == nil || o.SubscribeShareNameException == nil {
		return nil, false
	}
	return o.SubscribeShareNameException, true
}
...
// SetSubscribeShareNameException gets a reference to the given string and assigns it to the SubscribeShareNameException field.
func (o *MsgVpnAclProfileSubscribeShareNameException) SetSubscribeShareNameException(v string) {
	o.SubscribeShareNameException = &v
}

// GetSubscribeShareNameExceptionSyntax returns the SubscribeShareNameExceptionSyntax field value if set, zero value otherwise.
func (o *MsgVpnAclProfileSubscribeShareNameException) GetSubscribeShareNameExceptionSyntax() string {
	if o == nil || o.SubscribeShareNameExceptionSyntax == nil {
		var ret string
		return ret
	}
	return *o.SubscribeShareNameExceptionSyntax
}

// GetSubscribeShareNameExceptionSyntaxOk returns a tuple with the SubscribeShareNameExceptionSyntax field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnAclProfileSubscribeShareNameException) GetSubscribeShareNameExceptionSyntaxOk() (*string, bool) {
	if o == nil || o.SubscribeShareNameExceptionSyntax == nil {
		return nil, false
	}
	return o.SubscribeShareNameExceptionSyntax, true
}
...
// SetSubscribeShareNameExceptionSyntax gets a reference to the given string and assigns it to the SubscribeShareNameExceptionSyntax field.
func (o *MsgVpnAclProfileSubscribeShareNameException) SetSubscribeShareNameExceptionSyntax(v string) {
	o.SubscribeShareNameExceptionSyntax = &v
}

func (o MsgVpnAclProfileSubscribeShareNameException) MarshalJSON() ([]byte, error) {
	...
	if o.SubscribeShareNameException != nil {
		toSerialize["subscribeShareNameException"] = o.SubscribeShareNameException
	}
	if o.SubscribeShareNameExceptionSyntax != nil {
		toSerialize["subscribeShareNameExceptionSyntax"] = o.SubscribeShareNameExceptionSyntax
	}
	return json.Marshal(toSerialize)
}

type NullableMsgVpnAclProfileSubscribeShareNameException struct {
	value *MsgVpnAclProfileSubscribeShareNameException
	isSet bool
}

func (v NullableMsgVpnAclProfileSubscribeShareNameException) Get() *MsgVpnAclProfileSubscribeShareNameException {
	return v.value
}

func (v *NullableMsgVpnAclProfileSubscribeShareNameException) Set(val *MsgVpnAclProfileSubscribeShareNameException) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnAclProfileSubscribeShareNameException) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnAclProfileSubscribeShareNameException) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnAclProfileSubscribeShareNameException(val *MsgVpnAclProfileSubscribeShareNameException) *NullableMsgVpnAclProfileSubscribeShareNameException {
	return &NullableMsgVpnAclProfileSubscribeShareNameException{value: val, isSet: true}
}

func (v NullableMsgVpnAclProfileSubscribeShareNameException) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnAclProfileSubscribeShareNameException) UnmarshalJSON(src []byte) error {
	v.isSet = true
