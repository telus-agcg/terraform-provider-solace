...
// MsgVpnRestDeliveryPointQueueBinding struct for MsgVpnRestDeliveryPointQueueBinding
...
func NewMsgVpnRestDeliveryPointQueueBinding() *MsgVpnRestDeliveryPointQueueBinding {
	this := MsgVpnRestDeliveryPointQueueBinding{}
	return &this
}
...
// GetGatewayReplaceTargetAuthorityEnabled returns the GatewayReplaceTargetAuthorityEnabled field value if set, zero value otherwise.
func (o *MsgVpnRestDeliveryPointQueueBinding) GetGatewayReplaceTargetAuthorityEnabled() bool {
	if o == nil || o.GatewayReplaceTargetAuthorityEnabled == nil {
		var ret bool
		return ret
	}
	return *o.GatewayReplaceTargetAuthorityEnabled
}

// GetGatewayReplaceTargetAuthorityEnabledOk returns a tuple with the GatewayReplaceTargetAuthorityEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnRestDeliveryPointQueueBinding) GetGatewayReplaceTargetAuthorityEnabledOk() (*bool, bool) {
	if o == nil || o.GatewayReplaceTargetAuthorityEnabled == nil {
		return nil, false
	}
	return o.GatewayReplaceTargetAuthorityEnabled, true
}
...
// SetGatewayReplaceTargetAuthorityEnabled gets a reference to the given bool and assigns it to the GatewayReplaceTargetAuthorityEnabled field.
func (o *MsgVpnRestDeliveryPointQueueBinding) SetGatewayReplaceTargetAuthorityEnabled(v bool) {
	o.GatewayReplaceTargetAuthorityEnabled = &v
}
...
// GetPostRequestTarget returns the PostRequestTarget field value if set, zero value otherwise.
func (o *MsgVpnRestDeliveryPointQueueBinding) GetPostRequestTarget() string {
	if o == nil || o.PostRequestTarget == nil {
		var ret string
		return ret
	}
	return *o.PostRequestTarget
}

// GetPostRequestTargetOk returns a tuple with the PostRequestTarget field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnRestDeliveryPointQueueBinding) GetPostRequestTargetOk() (*string, bool) {
	if o == nil || o.PostRequestTarget == nil {
		return nil, false
	}
	return o.PostRequestTarget, true
}
...
// SetPostRequestTarget gets a reference to the given string and assigns it to the PostRequestTarget field.
func (o *MsgVpnRestDeliveryPointQueueBinding) SetPostRequestTarget(v string) {
	o.PostRequestTarget = &v
}
...
// GetRequestTargetEvaluation returns the RequestTargetEvaluation field value if set, zero value otherwise.
func (o *MsgVpnRestDeliveryPointQueueBinding) GetRequestTargetEvaluation() string {
	if o == nil || o.RequestTargetEvaluation == nil {
		var ret string
		return ret
	}
	return *o.RequestTargetEvaluation
}

// GetRequestTargetEvaluationOk returns a tuple with the RequestTargetEvaluation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnRestDeliveryPointQueueBinding) GetRequestTargetEvaluationOk() (*string, bool) {
	if o == nil || o.RequestTargetEvaluation == nil {
		return nil, false
	}
	return o.RequestTargetEvaluation, true
}

// HasRequestTargetEvaluation returns a boolean if a field has been set.
func (o *MsgVpnRestDeliveryPointQueueBinding) HasRequestTargetEvaluation() bool {
	if o != nil && o.RequestTargetEvaluation != nil {
		return true
	}
...
// SetRequestTargetEvaluation gets a reference to the given string and assigns it to the RequestTargetEvaluation field.
func (o *MsgVpnRestDeliveryPointQueueBinding) SetRequestTargetEvaluation(v string) {
	o.RequestTargetEvaluation = &v
}
...
func (o MsgVpnRestDeliveryPointQueueBinding) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.GatewayReplaceTargetAuthorityEnabled != nil {
		toSerialize["gatewayReplaceTargetAuthorityEnabled"] = o.GatewayReplaceTargetAuthorityEnabled
	}
	if o.MsgVpnName != nil {
		toSerialize["msgVpnName"] = o.MsgVpnName
	}
	if o.PostRequestTarget != nil {
		toSerialize["postRequestTarget"] = o.PostRequestTarget
	}
	if o.QueueBindingName != nil {
		toSerialize["queueBindingName"] = o.QueueBindingName
	}
	if o.RequestTargetEvaluation != nil {
		toSerialize["requestTargetEvaluation"] = o.RequestTargetEvaluation
	}
...
type NullableMsgVpnRestDeliveryPointQueueBinding struct {
	value *MsgVpnRestDeliveryPointQueueBinding
	isSet bool
}

func (v NullableMsgVpnRestDeliveryPointQueueBinding) Get() *MsgVpnRestDeliveryPointQueueBinding {
	return v.value
}

func (v *NullableMsgVpnRestDeliveryPointQueueBinding) Set(val *MsgVpnRestDeliveryPointQueueBinding) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnRestDeliveryPointQueueBinding) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnRestDeliveryPointQueueBinding) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnRestDeliveryPointQueueBinding(val *MsgVpnRestDeliveryPointQueueBinding) *NullableMsgVpnRestDeliveryPointQueueBinding {
	return &NullableMsgVpnRestDeliveryPointQueueBinding{value: val, isSet: true}
}

func (v NullableMsgVpnRestDeliveryPointQueueBinding) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnRestDeliveryPointQueueBinding) UnmarshalJSON(src []byte) error {
	v.isSet = true
