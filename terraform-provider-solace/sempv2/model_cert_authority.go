...
// CertAuthority struct for CertAuthority
...
func (o CertAuthority) MarshalJSON() ([]byte, error) {
...
type NullableCertAuthority struct {
	value *CertAuthority
	isSet bool
}

func (v NullableCertAuthority) Get() *CertAuthority {
	return v.value
}

func (v *NullableCertAuthority) Set(val *CertAuthority) {
	v.value = val
	v.isSet = true
}

func (v NullableCertAuthority) IsSet() bool {
	return v.isSet
}

func (v *NullableCertAuthority) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertAuthority(val *CertAuthority) *NullableCertAuthority {
	return &NullableCertAuthority{value: val, isSet: true}
}

func (v NullableCertAuthority) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertAuthority) UnmarshalJSON(src []byte) error {
	v.isSet = true
