...
// MsgVpnRestDeliveryPoint struct for MsgVpnRestDeliveryPoint
...
func (o MsgVpnRestDeliveryPoint) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnRestDeliveryPoint struct {
	value *MsgVpnRestDeliveryPoint
	isSet bool
}

func (v NullableMsgVpnRestDeliveryPoint) Get() *MsgVpnRestDeliveryPoint {
	return v.value
}

func (v *NullableMsgVpnRestDeliveryPoint) Set(val *MsgVpnRestDeliveryPoint) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnRestDeliveryPoint) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnRestDeliveryPoint) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnRestDeliveryPoint(val *MsgVpnRestDeliveryPoint) *NullableMsgVpnRestDeliveryPoint {
	return &NullableMsgVpnRestDeliveryPoint{value: val, isSet: true}
}

func (v NullableMsgVpnRestDeliveryPoint) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnRestDeliveryPoint) UnmarshalJSON(src []byte) error {
	v.isSet = true
