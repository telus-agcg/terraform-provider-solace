...
// MsgVpnReplicatedTopic struct for MsgVpnReplicatedTopic
...
// GetReplicatedTopic returns the ReplicatedTopic field value if set, zero value otherwise.
func (o *MsgVpnReplicatedTopic) GetReplicatedTopic() string {
	if o == nil || o.ReplicatedTopic == nil {
		var ret string
		return ret
	}
	return *o.ReplicatedTopic
}

// GetReplicatedTopicOk returns a tuple with the ReplicatedTopic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnReplicatedTopic) GetReplicatedTopicOk() (*string, bool) {
	if o == nil || o.ReplicatedTopic == nil {
		return nil, false
	}
	return o.ReplicatedTopic, true
}
...
// SetReplicatedTopic gets a reference to the given string and assigns it to the ReplicatedTopic field.
...
func (o MsgVpnReplicatedTopic) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.MsgVpnName != nil {
		toSerialize["msgVpnName"] = o.MsgVpnName
	}
	if o.ReplicatedTopic != nil {
		toSerialize["replicatedTopic"] = o.ReplicatedTopic
	}
...
type NullableMsgVpnReplicatedTopic struct {
	value *MsgVpnReplicatedTopic
	isSet bool
}

func (v NullableMsgVpnReplicatedTopic) Get() *MsgVpnReplicatedTopic {
	return v.value
}

func (v *NullableMsgVpnReplicatedTopic) Set(val *MsgVpnReplicatedTopic) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnReplicatedTopic) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnReplicatedTopic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnReplicatedTopic(val *MsgVpnReplicatedTopic) *NullableMsgVpnReplicatedTopic {
	return &NullableMsgVpnReplicatedTopic{value: val, isSet: true}
}

func (v NullableMsgVpnReplicatedTopic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnReplicatedTopic) UnmarshalJSON(src []byte) error {
	v.isSet = true
