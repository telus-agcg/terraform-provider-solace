...
// MsgVpnBridgeTlsTrustedCommonName struct for MsgVpnBridgeTlsTrustedCommonName
...
func NewMsgVpnBridgeTlsTrustedCommonName() *MsgVpnBridgeTlsTrustedCommonName {
	this := MsgVpnBridgeTlsTrustedCommonName{}
	return &this
}
...
func (o MsgVpnBridgeTlsTrustedCommonName) MarshalJSON() ([]byte, error) {
...
type NullableMsgVpnBridgeTlsTrustedCommonName struct {
	value *MsgVpnBridgeTlsTrustedCommonName
	isSet bool
}

func (v NullableMsgVpnBridgeTlsTrustedCommonName) Get() *MsgVpnBridgeTlsTrustedCommonName {
	return v.value
}

func (v *NullableMsgVpnBridgeTlsTrustedCommonName) Set(val *MsgVpnBridgeTlsTrustedCommonName) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnBridgeTlsTrustedCommonName) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnBridgeTlsTrustedCommonName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnBridgeTlsTrustedCommonName(val *MsgVpnBridgeTlsTrustedCommonName) *NullableMsgVpnBridgeTlsTrustedCommonName {
	return &NullableMsgVpnBridgeTlsTrustedCommonName{value: val, isSet: true}
}

func (v NullableMsgVpnBridgeTlsTrustedCommonName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnBridgeTlsTrustedCommonName) UnmarshalJSON(src []byte) error {
	v.isSet = true
