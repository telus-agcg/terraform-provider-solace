...
// ClientCertAuthorityOcspTlsTrustedCommonName struct for ClientCertAuthorityOcspTlsTrustedCommonName
...
func NewClientCertAuthorityOcspTlsTrustedCommonName() *ClientCertAuthorityOcspTlsTrustedCommonName {
	this := ClientCertAuthorityOcspTlsTrustedCommonName{}
	return &this
}
...
// GetOcspTlsTrustedCommonName returns the OcspTlsTrustedCommonName field value if set, zero value otherwise.
func (o *ClientCertAuthorityOcspTlsTrustedCommonName) GetOcspTlsTrustedCommonName() string {
	if o == nil || o.OcspTlsTrustedCommonName == nil {
		var ret string
		return ret
	}
	return *o.OcspTlsTrustedCommonName
}

// GetOcspTlsTrustedCommonNameOk returns a tuple with the OcspTlsTrustedCommonName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ClientCertAuthorityOcspTlsTrustedCommonName) GetOcspTlsTrustedCommonNameOk() (*string, bool) {
	if o == nil || o.OcspTlsTrustedCommonName == nil {
		return nil, false
	}
	return o.OcspTlsTrustedCommonName, true
}
...
// SetOcspTlsTrustedCommonName gets a reference to the given string and assigns it to the OcspTlsTrustedCommonName field.
func (o *ClientCertAuthorityOcspTlsTrustedCommonName) SetOcspTlsTrustedCommonName(v string) {
	o.OcspTlsTrustedCommonName = &v
}

func (o ClientCertAuthorityOcspTlsTrustedCommonName) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.CertAuthorityName != nil {
		toSerialize["certAuthorityName"] = o.CertAuthorityName
	}
	if o.OcspTlsTrustedCommonName != nil {
		toSerialize["ocspTlsTrustedCommonName"] = o.OcspTlsTrustedCommonName
	}
	return json.Marshal(toSerialize)
}

type NullableClientCertAuthorityOcspTlsTrustedCommonName struct {
	value *ClientCertAuthorityOcspTlsTrustedCommonName
	isSet bool
}

func (v NullableClientCertAuthorityOcspTlsTrustedCommonName) Get() *ClientCertAuthorityOcspTlsTrustedCommonName {
	return v.value
}

func (v *NullableClientCertAuthorityOcspTlsTrustedCommonName) Set(val *ClientCertAuthorityOcspTlsTrustedCommonName) {
	v.value = val
	v.isSet = true
}

func (v NullableClientCertAuthorityOcspTlsTrustedCommonName) IsSet() bool {
	return v.isSet
}

func (v *NullableClientCertAuthorityOcspTlsTrustedCommonName) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClientCertAuthorityOcspTlsTrustedCommonName(val *ClientCertAuthorityOcspTlsTrustedCommonName) *NullableClientCertAuthorityOcspTlsTrustedCommonName {
	return &NullableClientCertAuthorityOcspTlsTrustedCommonName{value: val, isSet: true}
}

func (v NullableClientCertAuthorityOcspTlsTrustedCommonName) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClientCertAuthorityOcspTlsTrustedCommonName) UnmarshalJSON(src []byte) error {
	v.isSet = true
