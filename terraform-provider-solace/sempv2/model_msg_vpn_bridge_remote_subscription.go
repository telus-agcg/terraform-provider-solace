...
// MsgVpnBridgeRemoteSubscription struct for MsgVpnBridgeRemoteSubscription
...
func NewMsgVpnBridgeRemoteSubscription() *MsgVpnBridgeRemoteSubscription {
	this := MsgVpnBridgeRemoteSubscription{}
	return &this
}
...
// GetDeliverAlwaysEnabled returns the DeliverAlwaysEnabled field value if set, zero value otherwise.
func (o *MsgVpnBridgeRemoteSubscription) GetDeliverAlwaysEnabled() bool {
	if o == nil || o.DeliverAlwaysEnabled == nil {
		var ret bool
		return ret
	}
	return *o.DeliverAlwaysEnabled
}

// GetDeliverAlwaysEnabledOk returns a tuple with the DeliverAlwaysEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnBridgeRemoteSubscription) GetDeliverAlwaysEnabledOk() (*bool, bool) {
	if o == nil || o.DeliverAlwaysEnabled == nil {
		return nil, false
	}
	return o.DeliverAlwaysEnabled, true
}
...
// SetDeliverAlwaysEnabled gets a reference to the given bool and assigns it to the DeliverAlwaysEnabled field.
func (o *MsgVpnBridgeRemoteSubscription) SetDeliverAlwaysEnabled(v bool) {
	o.DeliverAlwaysEnabled = &v
}
...
// GetRemoteSubscriptionTopic returns the RemoteSubscriptionTopic field value if set, zero value otherwise.
func (o *MsgVpnBridgeRemoteSubscription) GetRemoteSubscriptionTopic() string {
	if o == nil || o.RemoteSubscriptionTopic == nil {
		var ret string
		return ret
	}
	return *o.RemoteSubscriptionTopic
}

// GetRemoteSubscriptionTopicOk returns a tuple with the RemoteSubscriptionTopic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MsgVpnBridgeRemoteSubscription) GetRemoteSubscriptionTopicOk() (*string, bool) {
	if o == nil || o.RemoteSubscriptionTopic == nil {
		return nil, false
	}
	return o.RemoteSubscriptionTopic, true
}
...
// SetRemoteSubscriptionTopic gets a reference to the given string and assigns it to the RemoteSubscriptionTopic field.
func (o *MsgVpnBridgeRemoteSubscription) SetRemoteSubscriptionTopic(v string) {
	o.RemoteSubscriptionTopic = &v
}

func (o MsgVpnBridgeRemoteSubscription) MarshalJSON() ([]byte, error) {
	...
	if o.DeliverAlwaysEnabled != nil {
		toSerialize["deliverAlwaysEnabled"] = o.DeliverAlwaysEnabled
	}
	if o.MsgVpnName != nil {
		toSerialize["msgVpnName"] = o.MsgVpnName
	}
	if o.RemoteSubscriptionTopic != nil {
		toSerialize["remoteSubscriptionTopic"] = o.RemoteSubscriptionTopic
	}
	return json.Marshal(toSerialize)
}

type NullableMsgVpnBridgeRemoteSubscription struct {
	value *MsgVpnBridgeRemoteSubscription
	isSet bool
}

func (v NullableMsgVpnBridgeRemoteSubscription) Get() *MsgVpnBridgeRemoteSubscription {
	return v.value
}

func (v *NullableMsgVpnBridgeRemoteSubscription) Set(val *MsgVpnBridgeRemoteSubscription) {
	v.value = val
	v.isSet = true
}

func (v NullableMsgVpnBridgeRemoteSubscription) IsSet() bool {
	return v.isSet
}

func (v *NullableMsgVpnBridgeRemoteSubscription) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsgVpnBridgeRemoteSubscription(val *MsgVpnBridgeRemoteSubscription) *NullableMsgVpnBridgeRemoteSubscription {
	return &NullableMsgVpnBridgeRemoteSubscription{value: val, isSet: true}
}

func (v NullableMsgVpnBridgeRemoteSubscription) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsgVpnBridgeRemoteSubscription) UnmarshalJSON(src []byte) error {
	v.isSet = true
