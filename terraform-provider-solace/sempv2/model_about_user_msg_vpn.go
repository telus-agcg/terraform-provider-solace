...
// AboutUserMsgVpn struct for AboutUserMsgVpn
...
func (o AboutUserMsgVpn) MarshalJSON() ([]byte, error) {
...
type NullableAboutUserMsgVpn struct {
	value *AboutUserMsgVpn
	isSet bool
}

func (v NullableAboutUserMsgVpn) Get() *AboutUserMsgVpn {
	return v.value
}

func (v *NullableAboutUserMsgVpn) Set(val *AboutUserMsgVpn) {
	v.value = val
	v.isSet = true
}

func (v NullableAboutUserMsgVpn) IsSet() bool {
	return v.isSet
}

func (v *NullableAboutUserMsgVpn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAboutUserMsgVpn(val *AboutUserMsgVpn) *NullableAboutUserMsgVpn {
	return &NullableAboutUserMsgVpn{value: val, isSet: true}
}

func (v NullableAboutUserMsgVpn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAboutUserMsgVpn) UnmarshalJSON(src []byte) error {
	v.isSet = true
